...
/**
 * @method \SprykerEco\Zed\PaymentTemplate\Business\PaymentTemplateBusinessFactory getFactory()
 ...
 */
class PaymentTemplateFacade extends AbstractFacade implements PaymentTemplateFacadeInterface
{
    /**
     * {@inheritDoc}
     *
